...
def create_bounding_box(img, pose, pt_cld_data, intrinsic_matrix,color=(0,0,255),w=2):
    ...
    img = cv2.line(img, tuple(coord_2D[0]), tuple(coord_2D[1]), color, w)
    img = cv2.line(img, tuple(coord_2D[0]), tuple(coord_2D[3]), color, w)
    img = cv2.line(img, tuple(coord_2D[0]), tuple(coord_2D[4]), color, w)
    img = cv2.line(img, tuple(coord_2D[1]), tuple(coord_2D[2]), color, w)
    img = cv2.line(img, tuple(coord_2D[1]), tuple(coord_2D[5]), color, w)
    img = cv2.line(img, tuple(coord_2D[2]), tuple(coord_2D[3]), color, w)
    img = cv2.line(img, tuple(coord_2D[2]), tuple(coord_2D[6]), color, w)
    img = cv2.line(img, tuple(coord_2D[3]), tuple(coord_2D[7]), color, w)
    img = cv2.line(img, tuple(coord_2D[4]), tuple(coord_2D[7]), color, w)
    img = cv2.line(img, tuple(coord_2D[4]), tuple(coord_2D[5]), color, w)
    img = cv2.line(img, tuple(coord_2D[5]), tuple(coord_2D[6]), color, w)
    img = cv2.line(img, tuple(coord_2D[6]), tuple(coord_2D[7]), color, w)
